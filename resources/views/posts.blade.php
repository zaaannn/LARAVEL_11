<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        placeholder="Search any article?" type="search" id="search" name="search"
                        autocomplete="off">
                    </div>
                    <div>
        ...
        <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-10 lg:px-0">
    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-gray-300">
        ...
        <div>
            ...
            <a href="/authors/{{ $post->author->username }}" 
                class="hover:underline text-base text-gray-500">{{ $post->author->name }}</a> | {{ $post->created_at->diffForHumans() }}
            in 
            <a href="/categories/{{ $post->category->slug }}" class="hover:underline text-base text-gray-500">{{ $post->category->name }}</a>
        </div>
        <p class="my-4 font-light">{{ Str::limit($post['body'], 65) }}</p>
